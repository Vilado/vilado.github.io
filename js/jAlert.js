...
// 弹窗盒子
var jAlertParentCSS = "position: fixed; left: ;top: 50%; min-width: 100px; min-height: 200px; " +
    "margin-left:400px;margin-top: -100px; z-index: 1000; background-color: #ffffff; border-radius: 5px;";

// 弹窗抬头样式
var jAlertTitleCSS = "height: 45px; line-height: 45px; font-size: 1.5rem; padding-left: 20px;" +
    "background-color: #369ab7; color: #fff; border-radius: 5px 5px 0 0;";

// 弹窗内容
var jAlertContentCSS = "height: 200px; line-height: 20px; font-size: 1.3rem;" +
    "text-align: center; color: #333; word-wrap:break-word; padding: 30px 50px; letter-spacing: 3px;";
...
var jAlertButtonSureCSS = "height: 35px; line-height: 35px; padding: 0 20px; color: #fff;" +
    "font-size: 1.3rem; background-color: #369ab7; border-radius: 5px; cursor: pointer;";
